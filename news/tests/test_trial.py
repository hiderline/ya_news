...
# Создаём тестовый класс с произвольным названием,
# наследуем его от TestCase.
...
class TestNews(TestCase):
    ...
    def setUpTestData(cls):
        # Стандартным методом Django ORM create() создаём
        # объект класса.
    ...
    def test_successful_creation(self):
        # При помощи обычного ORM-метода посчитаем количество
        # записей в базе.
...
class Test(TestCase):
    ...
    def test_example_success(self):
        self.assertTrue(True)  # Самый успешный тест


# class YetAnotherTest(TestCase):

#     def test_example_fails(self):
#         self.assertTrue(False)  # Самый провальный тест
